...
const Toolbar: React.FC<ToolbarProps> = ({ 
  ...
  return (
    <div className="border-b-2 toolbar h-[48px] py-2 px-8 flex flex-nowrap gap-8 text-light-text bg-light-button-back ">
      
      <div className='flex flex-row justify-start gap-2'>
        <button   onClick={boldButtonAction}
                  className="w-8 p-1 rounded toolbar-button-bold hover:bg-light-active-component"
                  title='Bold (Ctrl + B)'>
        ...
        <button   onClick={italicButtonAction}
                  className="w-8 p-1 rounded toolbar-button-italic hover:bg-light-active-component"
                  title='Italic  (Ctrl + I)'>
        ...
        <button   onClick={striketroughAction}
                className="w-8 p-1 rounded toolbar-button-striketrough hover:bg-light-active-component"
        ...
        <button   onClick={quoteButtonAction}
                  className="w-8 p-1 rounded toolbar-button-quote hover:bg-light-active-component"
                  title='Quote  (Ctrl + Q)'>
        ...
        <button   onClick={codeButtonAction}
                  className="w-8 p-1 rounded toolbar-button-code-block hover:bg-light-active-component"
                  title='Code Block'>
        ...
        <button   onClick={unorderedListButtonAction}
                  className="w-8 p-1 rounded toolbar-button-unordered-list hover:bg-light-active-component"
        ...
        <button   onClick={orderedListButtonAction}
                  className="w-8 p-1 rounded toolbar-button-ordered-list hover:bg-light-active-component"
        ...
        <button   onClick={insertLinkButtonAction}
                  className="w-8 p-1 rounded toolbar-button-insert-link hover:bg-light-active-component"
        ...
        <button   onClick={insertImageButtonAction}
                  className="w-8 p-1 rounded toolbar-button-insert-image hover:bg-light-active-component"
        ...
        <button  onClick={() => headingButtonAction(1)}
                className="w-8 p-1 rounded toolbar-button-heading-1 hover:bg-light-active-component"
        ...
        <button onClick={() => headingButtonAction(2)}
                className="w-8 p-1 rounded toolbar-button-heading-2 hover:bg-light-active-component"
        ...
        <button onClick={() => headingButtonAction(3)}
                className="w-8 p-1 rounded toolbar-button-heading-3 hover:bg-light-active-component"
        ...
        <button   onClick={() => headingButtonAction(4)}
                  className="w-8 p-1 rounded toolbar-button-heading-4 hover:bg-light-active-component"
        ...
        <button   onClick={() => headingButtonAction(5)}
                  className="w-8 p-1 rounded toolbar-button-heading-5 hover:bg-light-active-component"
        ...
        <button   onClick={() => headingButtonAction(6)}
                  className="w-8 p-1 rounded toolbar-button-heading-6 hover:bg-light-active-component"
        ...
        <button 
                  className="w-8 p-1 rounded toolbar-button-divider hover:bg-light-active-component"
                  title='Divider Line'>
      ...
      <div className='flex gap-3.5 theme-switcher'>
        <button  
                  className="w-8 p-1 rounded toolbar-theme-light hover:bg-light-active-component"
                  title='Light Theme'>
        ...
        <button  
                  className="w-8 p-1 rounded toolbar-theme-dark hover:bg-light-active-component"
                  title='Dark Theme'>
