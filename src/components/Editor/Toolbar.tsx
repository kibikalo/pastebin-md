...
const Toolbar: React.FC<ToolbarProps> = ({ boldButtonAction, italicButtonAction, quoteButtonAction , headingButtonAction, unorderedListButtonAction, orderedListButtonAction }) => {
  ...
  return (
    <div className="toolbar mr-80 py-2 px-8 flex flex-row flex-nowrap gap-3.5 rounded-[30px] bg-gray-900">
      ...
      <button  onClick={() => headingButtonAction(1)}
              className="toolbar-button-heading-1 w-8 bg-gray-700 rounded p-1 hover:bg-gray-600"
      ...
      <button onClick={() => headingButtonAction(2)}
              className="toolbar-button-heading-2 w-8 bg-gray-700 rounded p-1 hover:bg-gray-600"
      ...
      <button onClick={() => headingButtonAction(3)}
              className="toolbar-button-heading-3 w-8 bg-gray-700 rounded p-1 hover:bg-gray-600"
      ...
      <button   onClick={() => headingButtonAction(4)}
                className="toolbar-button-heading-4 w-8 bg-gray-700 rounded p-1 hover:bg-gray-600"
      ...
      <button   onClick={() => headingButtonAction(5)}
                className="toolbar-button-heading-5 w-8 bg-gray-700 rounded p-1 hover:bg-gray-600"
      ...
      <button   onClick={() => headingButtonAction(6)}
                className="toolbar-button-heading-6 w-8 bg-gray-700 rounded p-1 hover:bg-gray-600"
