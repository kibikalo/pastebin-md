...
const Toolbar: React.FC<ToolbarProps> = ({ 
  ...
  insertImageButtonAction }) => {
    ...
    return (
      <div className="toolbar h-[48px] py-2 px-8 flex justify-between flex-nowrap gap-8 text-light-text dark:text-dark-text bg-light-button-back dark:bg-dark-button-back border-b-2 border-light-border dark:border-dark-border">
